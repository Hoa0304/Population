...
//    }
    ...
    public static void insertResident (String name, String cccd, String sshk, String NOphone, String address, String job, String sex, String birt) throws SQLException, ClassNotFoundException {
        ...
        String updateStmt =
                "BEGIN\n" +
                        ...
                        "VALUES\n" +
                        "(sequence_resident.nextval, '"+name+"', '"+cccd+"','"+sshk+"','"+NOphone+"','"+address+"','"+sex+"', '"+birt+"','"+job+"', SYSDATE, 'IT_PROG');\n" +
                        "END;";
